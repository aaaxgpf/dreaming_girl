  ...
  const handleSendMessage = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const assistantMessage: ChatMessage = {
        ...
        role: 'assistant',
        content: data.korean || data.content || '응응! 네 말 잘 듣고 있어~',
        korean: data.korean,
      ...
      // Play audio automatically removed based on user preference
    } catch (err) {
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-1.5 pt-1 flex-wrap">
                          ...
                          <button
                            type="button"
                            onClick={() => playAudio(msg.korean || msg.content || '', msg.id)}
