  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-transparent p-4 md:p-8 pb-32">
      <div className="max-w-2xl mx-auto w-full space-y-6">
        <h1 className="text-3xl font-medium tracking-tight text-stone-800 px-2 mt-8 mb-8">Study</h1>
        <div className="space-y-3">
          {menus.map(menu => (
            ...
            >
              <div className={`w-12 h-12 flex items-center justify-center shrink-0 ${menu.color} mr-4`}>
                <menu.icon size={24} />
              </div>
              ...
              <div className="w-8 h-8 flex items-center justify-center transition-colors opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 duration-300 ease-out">
